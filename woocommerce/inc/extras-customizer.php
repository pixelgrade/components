...
/*
 * ====================================
 * WOOCOMMERCE GRID CALLBACKS
 * ==================================== */

/**
 * Returns the custom CSS rules for the woocommerce grid spacing depending on the Customizer settings.
 *
 ...
 * @return string
 */
function pixelgrade_woocommerce_grid_vertical_spacing_cb( $value, $selector, $property, $unit ) {
...
function pixelgrade_woocommerce_grid_horizontal_spacing_cb( $value, $selector, $property, $unit ) {
	$output = '';
...
/**
 * Inline enqueues the JS code used in the Customizer for the woocommerce grid spacing live preview.
 */
function pixelgrade_woocommerce_grid_vertical_spacing_cb_customizer_preview() {
	$js = '';
...
function pixelgrade_woocommerce_grid_vertical_spacing_cb( value, selector, property, unit ) {
	...
	var css = '',
		style = document.getElementById('woocommerce_grid_vertical_spacing_style_tag'),
	...
	if ( style !== null ) {
		...
		style.setAttribute('id', 'woocommerce_grid_spacing_style_tag');
...
add_action( 'customize_preview_init', 'pixelgrade_woocommerce_grid_vertical_spacing_cb_customizer_preview', 20 );

/**
 * Inline enqueues the JS code used in the Customizer for the woocommerce grid spacing live preview.
 */
function pixelgrade_woocommerce_grid_horizontal_spacing_cb_customizer_preview() {
	$js = '';
...
add_action( 'customize_preview_init', 'pixelgrade_woocommerce_grid_horizontal_spacing_cb_customizer_preview', 20 );

/*
 * ===============================
 * WOOCOMMERCE GRID CONTROLS CONDITIONALS
 * =============================== */

/**
 * Decides when to show the woocommerce grid title nearby alignment control.
 *
 * @return bool
 */
...
/**
 * Decides when to show the woocommerce grid title overlay alignment control.
 *
 * @return bool
 */
function pixelgrade_woocommerce_items_title_alignment_overlay_control_show() {
	$position = pixelgrade_option( 'woocommerce_items_title_position' );
...
/**
 * Decides when to show the woocommerce grid items aspect ratio control.
 *
 * @return bool
 */
function pixelgrade_woocommerce_items_aspect_ratio_control_show() {
	$layout = pixelgrade_option( 'woocommerce_grid_layout' );
