<?php
/**
 * The template part used for displaying jetpack-portfolio content on archives
 *
...
$location = pixelgrade_get_location( 'jetpack-portfolio' );

pixelgrade_the_card( 'portfolio', $location );
