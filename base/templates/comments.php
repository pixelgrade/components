 ...
 * by putting it in the root `/comments.php` or in `/templates/base/comments.php`.
...
<div id="comments" class="comments-area  o-wrapper  u-container-width">
	<div class="u-content-width">
		...
		<label for="comments-toggle" class="c-btn  c-comments-toggle__label">
			<span class="c-comments-toggle__icon"><?php pixelgrade_get_component_template_part( Pixelgrade_Base::COMPONENT_SLUG,'svg/comments-toggle-icon' ); ?></span>
