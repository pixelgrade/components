 ...
 * by putting it in the root `/single.php` or in `/templates/base/single.php`.
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			while ( have_posts() ) : the_post();
				 ...
				 */
				pixelgrade_get_component_template_part( Pixelgrade_Base::COMPONENT_SLUG, 'content-single', get_post_format(), true );
