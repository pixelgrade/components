 ...
 * by putting it in the root `/search.php` or in `/templates/base/search.php`.
			...
			<div class="u-blog-sides-spacing  u-content-top-spacing  u-content-bottom-spacing  <?php echo $visibility_class; ?>">
				<div class="o-wrapper u-blog-grid-width">
					...
					<header class="entry-header  c-page-header">
						<h1 class="entry-title"><?php printf( esc_html__( 'Search Results for: %s', 'components_txtd' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
