 ...
 * in `/page-templates/base/full-width-no-title.php` or `/page-templates/full-width-no-title.php`
 *
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			if ( have_posts() ) {
				...
				pixelgrade_get_component_template_part( Pixelgrade_Base::COMPONENT_SLUG,'content', 'page', true );
