			...
			$default_config = array(
				...
				'fields'                 => array(
					...
					'source'                  => array(
						...
						'desc'     => esc_html__( '👉 More Posts Source options (e.g. Category, Tag, Selected Posts) are available in the Pro version of ' . wp_get_theme( get_template() )->get('Name') . '. C\'mon, aim for more, mate!', '__theme_txtd' ),
						'default'  => 'recent',
						'section'  => 'content',
						'priority' => 10,
					),
					...
					'secondary_meta'          => array(
						...
						'desc'     => esc_html__( '👉 More display options (e.g. Show Excerpt, Show Read More) are available in the Pro version of ' . wp_get_theme( get_template() )->get('Name') . '. Don\'t let us stop you!', '__theme_txtd' ),
						'options'  => array(
