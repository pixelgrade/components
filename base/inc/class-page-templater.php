...
if ( ! class_exists( 'Pixelgrade_Page_Templater' ) ) :

class Pixelgrade_Page_Templater {
	...
	public function __construct( $component, $templates = array() ) {
		...
		if ( version_compare( floatval( get_bloginfo( 'version' ) ), '4.7', '<' ) ) {
			...
			add_filter(
				'theme_page_templates', array( $this, 'add_new_template_to_dropdown' )
			);
		}
	 ...
	 *
	 */
	public function add_new_template_to_dropdown( $posts_templates ) {
