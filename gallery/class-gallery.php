 ...
 */
class Pixelgrade_Gallery_Settings extends Pixelgrade_Component_Main {

	const COMPONENT_SLUG = 'gallery';
	...
	/**
	 * Pixelgrade_Gallery_Settings constructor.
	 *
	...
	function admin_init() {
		...
		wp_register_style( 'pixelgrade_gallery-admin-style', pixelgrade_get_theme_file_uri( trailingslashit( PIXELGRADE_COMPONENTS_PATH ) . trailingslashit( self::COMPONENT_SLUG ) . 'css/admin.css' ), array(), $this->_assets_version );
	}
	...
	function wp_enqueue_media() {
		...
		if ( ! wp_script_is( 'pixelgrade-gallery-settings', 'registered' ) ) {
			wp_register_script( 'pixelgrade-gallery-settings', pixelgrade_get_theme_file_uri( trailingslashit( PIXELGRADE_COMPONENTS_PATH ) . trailingslashit( self::COMPONENT_SLUG ) . 'js/gallery-settings.js' ), $dependecies, $this->_assets_version );
		}
